...
void main(List<String> args) {
  ...
  print(boxString.getData('321')?.toString()); // PIN salah
  print(boxString.getData('123')?.toString()); // PIN benar
  ...
  print(bayu.getData('123')?.name); // Gunakan ?. karena hasilnya bisa null
}
